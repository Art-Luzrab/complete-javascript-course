...
console.log(maskCreditCard(45555344444444));
console.log(maskCreditCard(4534654));
console.log(maskCreditCard('3342345245353'));
...
console.log(new Set('ArthurBarzul').size);
...
// Arrays
const users = [{ name: 'Arthur', email: 'arty@gmail.com' }];
// const users = [];
...
// Nullish assignment operator (??=) (nullish or undefined)
rest1.numGuests ??= 10;
rest2.numGuests ??= 10;
...
//REST, because of LEFT side of equals sign
